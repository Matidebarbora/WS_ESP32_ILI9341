...
void lv_create_main_gui(void) {
 ...
 //-------------------- TEMPERATURE ICON ------------------------------------------------------------------
  ...
  lv_obj_set_pos(weather_image_temperature, 115, 115);
 ...
 // ------------------- TEMPERATURE LABEL -----------------------------------------------------------------
  ...
  lv_label_set_text(text_label_temperature, String("     " + temperature + degree_symbol).c_str());
  lv_obj_set_pos(text_label_temperature, 95, 112);
  lv_obj_set_style_text_font((lv_obj_t*) text_label_temperature, &lv_font_montserrat_28, 0);
 ...
 // ------------------- HUMIDITY ICON ---------------------------------------------------------------------
  ...
  lv_obj_set_pos(weather_image_humidity, 210, 115);
 ...
 // ------------------- HUMIDITY LABEL --------------------------------------------------------------------
  ...
  lv_label_set_text(text_label_humidity, String("   " + humidity + "%").c_str());
  lv_obj_set_pos(text_label_humidity, 215, 112);
  lv_obj_set_style_text_font((lv_obj_t*) text_label_humidity, &lv_font_montserrat_28, 0);
 ...
 // ------------------- TIME JMD --------------------------------------------------------------------------
  ...
  lv_obj_set_pos(timeLabel, 75, 25);
...
void update_time_label() {
    ...
    if (getLocalTime(&timeinfo)) {
        ...
        strftime(date_str, sizeof(date_str), "%d/%m/%Y", &timeinfo);
        strftime(day_str, sizeof(day_str), "%a", &timeinfo);
        strftime(time_str, sizeof(time_str), "%H:%M:%S", &timeinfo); // strftime(time_str, sizeof(time_str), "%H:%M:%S", &timeinfo);
